...
import com.hotellook.ui.view.tabview.SlidingTabLayout.TabColorizer;

class SlidingTabStrip extends LinearLayout {
    private static final byte DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = (byte) 38;
    private static final int DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS = 0;
    static final int DEFAULT_SELECTED_INDICATOR_COLOR = -13388315;
    static final int SELECTED_INDICATOR_THICKNESS_DIPS = 3;
    ...
    public void setSelectedIndicatorThickness(int height) {
        this.mSelectedIndicatorThickness = height;
        invalidate();
    }
