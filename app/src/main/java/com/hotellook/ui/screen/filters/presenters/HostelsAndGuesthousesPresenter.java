...
public class HostelsAndGuesthousesPresenter extends BoolFilterPresenter {
    public HostelsAndGuesthousesPresenter(@NonNull HostelsAndGuesthousesFilterItem filterItem) {
        super(filterItem);
    }
    ...
    public View createView(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        ...
        ((TextView) view.findViewById(C1759R.id.title)).setText(C1178R.string.hide_hostels_and_guesthouses);
