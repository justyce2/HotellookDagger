...
public class AgencyPresenter extends BoolFilterPresenter {
    private final AgencyFilterItem filterItem;

    public AgencyPresenter(@NonNull AgencyFilterItem filterItem) {
        super(filterItem);
    ...
    public View createView(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        ...
        ((TextView) view.findViewById(C1759R.id.title)).setText(this.filterItem.getAgencyName());
